<?php
	$file_handle = fopen("/home/sburgholzer/topTenHour.txt", "r");	
	...
	$csvData = file_get_contents('/home/sburgholzer/warmest.txt');
	...
	$csvData = file_get_contents('/home/sburgholzer/coldest.txt');
	$lines = explode(PHP_EOL, $csvData);
	$coldest = array();
	foreach ($lines as $line) {
...
<html lang="en">
  ...
  <body>
    ...
    <div id="graphs">
		<br /><br /><br /><center><a href="map.php?item=Warmest">Warmest</a> | <a href="map.php?item=Coldest">Coldest</a></center>
		<center>
		<?php
